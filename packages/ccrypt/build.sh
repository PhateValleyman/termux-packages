TERMUX_PKG_HOMEPAGE=https://ccrypt.sourceforge.net/
...
TERMUX_PKG_SRCURL=https://ccrypt.sourceforge.net/download/$TERMUX_PKG_VERSION/ccrypt-$TERMUX_PKG_VERSION.tar.gz
